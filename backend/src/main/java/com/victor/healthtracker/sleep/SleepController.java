 ...
 * -addSession(session): Endpoint POST care adauga o sesiune de somn noua (session = sesiunea de salvat, valideaza ca ora de trezire sa fie dupa ora de culcare, returneaza sesiunea salvata)
 * -deleteSession(id): Endpoint DELETE care sterge o sesiune de somn dupa ID (id = ID-ul sesiunii de sters)
 */
@RestController
